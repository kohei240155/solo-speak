...
CREATE TABLE "users" (
    ...
    "default_learning_language_id" TEXT,
    "email" TEXT NOT NULL,
    "stripe_customer_id" TEXT,
    "remaining_phrase_generations" INTEGER NOT NULL DEFAULT 0,
    "last_phrase_generation_date" TIMESTAMP(3),
...
CREATE TABLE "phrases" (
    ...
    "session_spoken" BOOLEAN NOT NULL DEFAULT false,
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_default_learning_language_id_fkey" FOREIGN KEY ("default_learning_language_id") REFERENCES "languages"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "situations" ADD CONSTRAINT "situations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
