...
### 🚀 ブランチ準備（大規模修正の場合）
- [ ] リリースブランチ作成: `release/modify-{機能名}`
- [ ] 分析用ブランチ作成: `feature/modify-{機能名}/analysis`
...
| PR | ブランチ | ベース | URL |
|----|----------|--------|-----|
| 修正 | modify/{機能名} | main | #___ |

### 大規模修正（200行超）の場合
| PR | ブランチ | ベース | URL |
|----|----------|--------|-----|
| 影響分析 | feature/modify-{機能名}/analysis | release/modify-{機能名} | #___ |
| バックエンド | feature/modify-{機能名}/backend | release/modify-{機能名} | #___ |
| フロントエンド | feature/modify-{機能名}/frontend | release/modify-{機能名} | #___ |
| リリース | release/modify-{機能名} | main | #___ |
