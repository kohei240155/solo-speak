...
export const initialSituations = {
	...
	// Chinese (中国語)
	zh: ["和朋友聊天时", "在咖啡厅点餐时", "商务对话中"],
	// Hindi (ヒンディー語)
	hi: ["दोस्तों के साथ बातचीत में", "कैफे में ऑर्डर करते समय", "व्यापारिक बातचीत में"],
	// Spanish (スペイン語)
	es: [
	...
	// Korean (韓国語)
	ko: ["친구들과의 대화에서", "카페에서 주문할 때", "비즈니스 대화에서"],
	// Italian (イタリア語)
	it: [
	...
	// Thai (タイ語)
	th: ["ในการสนทนากับเพื่อน", "เมื่อสั่งในร้านกาแฟ", "ในการสนทนาทางธุรกิจ"],
	// Dutch (オランダ語)
	nl: [
