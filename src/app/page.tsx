      ...
      >
        <div className="container mx-auto px-4 sm:px-8">
          ...
          <div className="max-w-5xl mx-auto space-y-6 px-2 sm:px-4">
            {/* お悩み 1 */}
            <div className={`bg-gradient-to-r from-gray-50 to-gray-100 p-4 sm:p-6 md:p-8 rounded-2xl shadow-lg border border-gray-200 transition-all duration-1000 ease-out transform overflow-hidden hover:shadow-xl hover:scale-105 ${
              visibleSections.has('features-section') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
            }`} style={{ 
              transitionDelay: '400ms',
              transform: visibleSections.has('features-section') ? 'translateY(0) scale(1)' : 'translateY(48px) scale(0.95)',
              ...
              <div className="flex items-start gap-4">
                <div 
                  className={`w-6 h-6 rounded flex items-center justify-center mt-1 flex-shrink-0 transition-all duration-1000 ease-out ${
                    visibleSections.has('features-section') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-16'
                  }`}
                ...
                <p className={`text-lg md:text-xl text-gray-800 font-medium leading-relaxed transition-all duration-1000 ease-out ${
                  visibleSections.has('features-section') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'
                    ...
                    <div className="mb-4 md:mb-8">
                      ...
                      <div className="min-h-[5rem] flex items-start mb-4 overflow-hidden">
                        <div className="w-full relative">
                          ...
                          {/* 実際に表示されるテキスト */}
                          <div className={`text-base md:text-xl text-gray-600 break-words leading-relaxed font-medium transition-all duration-1000 ease-out absolute top-0 left-0 w-full ${
                            showQuizTranslation 
