...
export const SWR_KEYS = {
  ...
  PHRASE_LIST: (language: string, page: number) => `/api/phrase?languageCode=${language}&page=${page}&limit=10&minimal=true`,
  ...
  // ダッシュボード関連
  DASHBOARD: (language?: string) => language ? `/api/dashboard?language=${language}` : '/api/dashboard',
