...
export function getPhraseLevelNameByCorrectAnswers(correctAnswers: number): string {
  const score = getPhraseLevelScoreByCorrectAnswers(correctAnswers)
...
export function getPhraseLevelDescriptionByCorrectAnswers(correctAnswers: number): string {
  const score = getPhraseLevelScoreByCorrectAnswers(correctAnswers)
...
export function getPhraseLevelInfoByCorrectAnswers(correctAnswers: number): PhraseLevelInfo {
  const score = getPhraseLevelScoreByCorrectAnswers(correctAnswers)
...
export function getPhraseLevelBorderStyle(correctAnswers: number): React.CSSProperties {
  const color = getPhraseLevelColorByCorrectAnswers(correctAnswers)
  return {
