        ...
        <div className="space-y-4">
          <div>
            <div className="flex items-center mb-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">{t('phraseGeneration.help.resetTime.title')}</h3>
            </div>
          ...
          <div>
            <div className="flex items-center mb-2">
              <AiOutlineCaretRight className="w-4 h-4 mr-1 text-gray-600" />
              <h3 className="text-lg font-semibold text-gray-900">{t('phraseGeneration.help.dailyLimit.title')}</h3>
            </div>
