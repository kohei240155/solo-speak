        ...
        <div className="space-y-4">
          <div>
            <div className="flex items-center mb-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">{t('speak.explanation.dailyGoal.title')}</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-5 pr-4">
              {t('speak.explanation.dailyGoal.description')}
            </p>
          </div>
          ...
          <div>
            <div className="flex items-center mb-2">
              <AiOutlineCaretRight className="w-4 h-4 mr-1 text-gray-600" />
              <h3 className="text-lg font-semibold text-gray-900">{t('speak.explanation.practiceCount.title')}</h3>
            </div>
            <p className="text-gray-700 leading-relaxed ml-5 pr-4">
              {t('speak.explanation.practiceCount.description')}
            </p>
          </div>
          ...
          <div>
            <div className="flex items-center mb-2">
              <AiOutlineCaretRight className="w-4 h-4 mr-1 text-gray-600" />
              <h3 className="text-lg font-semibold text-gray-900">{t('speak.explanation.effectiveMethods.title')}</h3>
            </div>
