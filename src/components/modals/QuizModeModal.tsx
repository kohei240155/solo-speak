...
export default function QuizModeModal({
  isOpen,
  onClose,
  onStart,
  languages,
    ...
    configItems: [
      {
        ...
        onChange: (value: string | boolean) =>
          setMode(value as "normal" | "random"),
      },
      {
        id: "questionCount",
        ...
        onChange: (value: string | boolean) =>
          setQuestionCount(parseInt(value as string, 10)),
      },
      {
        id: "speakCountFilter",
        ...
        onChange: (value: string | boolean) => {
          ...
          setSpeakCountFilter(
            stringValue === "" ? null : parseInt(stringValue, 10),
          );
        },
      },
      {
        ...
        onChange: (value: string | boolean) =>
          setExcludeTodayQuizzed(value as boolean),
      },
    ],
    onStart: handleStart,
