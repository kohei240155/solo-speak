    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="w-10 h-10 bg-gray-300 rounded-full flex items-center justify-center overflow-hidden border border-gray-300">
              ...
              <img
                src={
                  currentImage.startsWith("data:")
                    ? currentImage
                    : `${currentImage}${currentImage.includes("?") ? "&" : "?"}t=${Date.now()}`
                }
                alt="User Icon"
          ...
          <div className="flex space-x-2">
            ...
            {currentImage &&
              currentImage.trim() !== "" &&
              !currentImage.includes("/images/user-icon/user-icon.png") && (
                <button
                  type="button"
