...
export default function HeroSection({ onGetStartedClick }: HeroSectionProps) {
	...
	return (
		...
		>
			{/* 背景の装飾要素 */}
			<div
				className={`absolute inset-0 opacity-30 transition-opacity duration-1500 ease-out ${
			...
			<div className="container mx-auto px-4 sm:px-8 relative z-10">
				<div className="max-w-6xl mx-auto">
					...
					<div className="flex flex-col items-center text-center lg:hidden space-y-2 px-2">
						{/* サブタイトル */}
						<p
							className={`text-base sm:text-lg md:text-xl text-gray-600 font-medium w-full max-w-2xl transition-all duration-1000 ease-out ${
								animationStarted
						...
						{/* メインタイトル */}
						<h1
							className={`text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 tracking-tight w-full max-w-2xl mb-4 transition-all duration-1000 ease-out ${
								animationStarted
									? "opacity-100 translate-y-0"
									: "opacity-0 translate-y-8"
							}`}
						...
						{/* アプリ画像 */}
						<div
							className={`flex items-center justify-center mt-6 transition-all duration-1000 ease-out ${
								animationStarted
									? "opacity-100 translate-y-0"
									: "opacity-0 translate-y-8"
							}`}
						...
						{/* 特徴リスト */}
						<div
							className={`bg-white backdrop-blur-sm rounded-xl p-6 border border-gray-200 shadow-lg w-full max-w-2xl mx-2 mt-6 transition-all duration-1000 ease-out ${
								animationStarted
									? "opacity-100 translate-y-0"
									: "opacity-0 translate-y-8"
							}`}
					...
					<div className="hidden lg:grid lg:grid-cols-[3fr_2fr] gap-4 items-start">
						...
						<div className="text-left max-w-4xl">
							{/* サブタイトル */}
							<p
								className={`text-2xl text-gray-600 font-medium transition-all duration-1000 ease-out ${
									animationStarted
										? "opacity-100 translate-y-0"
										: "opacity-0 translate-y-8"
								}`}
							...
							{/* メインタイトル */}
							<h1
								className={`text-7xl font-bold text-gray-900 mb-8 leading-tight tracking-tight transition-all duration-1000 ease-out ${
									animationStarted
										? "opacity-100 translate-y-0"
										: "opacity-0 translate-y-8"
								}`}
							...
							{/* 特徴リスト */}
							<div
								className={`bg-white backdrop-blur-sm rounded-xl p-6 border border-gray-200 shadow-lg mb-8 max-w-lg transition-all duration-1000 ease-out ${
									animationStarted
										? "opacity-100 translate-y-0"
										: "opacity-0 translate-y-8"
								}`}
