...
export default function BrowserSwitchHelpModal({ isOpen, onClose }: BrowserSwitchHelpModalProps) {
  const { t } = useTranslation()

  return (
    <BaseModal isOpen={isOpen} onClose={onClose} title={t('auth.modal.browserSwitchHelp.title')} width="500px">
